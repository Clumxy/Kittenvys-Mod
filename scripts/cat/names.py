...
class Name():
    ...
    normal_prefixes = [
        ...
        'Biting', 'Bitten', 'Bittern', 'Blaze', 'Bleak', 'Blink', 'Blinking', 'Blooming', 'Blossoming', 
        'Blotch','Blotched', 'Blotchy', 'Bluebell', 'Boar', 'Bog', 'Bold', 'Bolete', 'Bolt', 'Bone', 'Bough', 'Bouncing',
    ...
    loner_names = [
        ...
        "Frankie", "Hotdog", "Beverly", "Mera", "Tasha", "Kittenvy"
    ]
